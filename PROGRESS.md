...
**4 / 11 assignments completed** ████░░░░░░ 36%

---

## Assignment Status

| # | Assignment | Week | Notebook | Branch | Status |
|---|------------|------|----------|--------|--------|
| ML-01 | Repo Setup & Colab Badges | 0 | — | [`assignment/ML-01-setup`](../../tree/assignment/ML-01-setup) | ☑ Done |
...
| ML-05 | Feature Leakage Check (optional stretch) | 3 | `w03_feature_leakage_check.ipynb` | — | optional |
| ML-06 | Signal Audit (optional stretch) | 4 | `w04_signal_audit.ipynb` | — | optional |
| ML-07 | Baseline Score | 4 | `w04_baseline_score.ipynb` | — | ☐ Pending |
| ML-08 | Model Training | 5 | `w05_model.ipynb` | — | ☐ Pending |
| ML-09 | Validation Audit | 6 | `w06_validation_audit.ipynb` | — | ☐ Pending |
| ML-10 | Action Playbook | 7 | `w07_action_playbook.ipynb` | — | ☐ Pending |
| ML-11 | Capstone | 8 | `capstone.ipynb` | — | ☐ Pending |
| ML-12 | Demo & Portfolio Wrap-up | 8 | `capstone.ipynb` (closing cells) | — | ☐ Pending |
...
The next assignment to complete is **ML-07 — Baseline Score** (`w04_baseline_score.ipynb`).
